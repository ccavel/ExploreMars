...
Le premier fait bien référence au fait qu’un groupe d'individus comprennent une même 
...
<div class="row">
  <div class="col-xl-3 col-sm-3 text-center">
    <div class="box">
  <img src="images/xavier.jpg" alt="Expérience" width=90%>
  <p class="text-justify">
  «La conscience de situation collective est majoritairement présentée par la notion de représentation partagée entre acteurs 
  engagés dans un processus actif de coopération en vue de réaliser un but commun» <br/>
  Xavier Chalandon</p>
  </div>
  </div>
<div class="col">
...
La CS est rendue possible car les individus ont des ressources de traitement d’informations comme la mémoire,
 ...
 l’environnement, la pression et le stress agissent et ont un impact sur la prise de décision, la performance
  et donc la CS. Dans certains cas, elle influence comment l’attention des individus est dirigée, comment 
  l’information est perçue et interprétée. Les individus sont actifs pour rassembler les informations importantes
   et nécessaires, ils jouent donc un rôle dans leur propre CS : les individus doivent travailler sur eux même 
   pour l’avoir et la maintenir.

La CS est un concept dynamique qui est limité par la capacité d’attention et de mémoire de travail des individus.
</div>
</div>
</div>
...
<a href="notreExpe.php" class="btn bg-light" role="button" style="color:rgb(121, 0, 0)">Voir la suite >> </a>
</div> 
<br/>
<br/>
